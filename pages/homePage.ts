...
export class HomePage {
  ...
  async sortProducts(order: string): Promise<void> {
  ...
  async responseWaiting(
    ...
    const response = await this.page.waitForResponse(
      (res) =>
        res
          .url()
          .startsWith("https://api.practicesoftwaretesting.com/products") && // use regexp
